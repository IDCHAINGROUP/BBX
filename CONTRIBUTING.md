...
The ballotbox project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ballotboxcoin/bbx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ballotbox project, and is not to be
confused with overall ballotbox Network Protocol consensus changes.

Whether a pull request is merged into ballotbox rests with the project merge
...
Patches that change ballotbox consensus rules are considerably more involved than
...
Where a patchset proposes to change the ballotbox consensus, it must have been
...
The project leader is the release manager for each ballotbox release.
