...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ballotbox-cli.cpp \
           src/ballotbox-tx.cpp \
           src/ballotbox.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ballotbox.qrc src/qt/ballotbox_locale.qrc

TRANSLATIONS += src/qt/locale/ballotbox_bg.ts \
                src/qt/locale/ballotbox_de.ts \
                src/qt/locale/ballotbox_en.ts \
                src/qt/locale/ballotbox_es.ts \
                src/qt/locale/ballotbox_fi.ts \
                src/qt/locale/ballotbox_fr.ts \
                src/qt/locale/ballotbox_it.ts \
                src/qt/locale/ballotbox_ja.ts \
                src/qt/locale/ballotbox_pl.ts \
                src/qt/locale/ballotbox_pt.ts \
                src/qt/locale/ballotbox_ru.ts \
                src/qt/locale/ballotbox_sk.ts \
                src/qt/locale/ballotbox_sv.ts \
                src/qt/locale/ballotbox_vi.ts \
                src/qt/locale/ballotbox_zh_CN.ts \
                src/qt/locale/ballotbox_zh_TW.ts
