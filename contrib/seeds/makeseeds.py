...
def main():
    ...
    # Filter out hosts with multiple ballotbox ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple ballotbox ports' % (ip_stats(ips)), file=sys.stderr)
