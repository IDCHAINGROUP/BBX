...
The script [extract-osx-sdk.sh](https://github.com/ballotboxcoin/bbx/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ballotbox/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ballotboxcoin/bbx/blob/master/doc/README_osx.md) for troubleshooting tips.
