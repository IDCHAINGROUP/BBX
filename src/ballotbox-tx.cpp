...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ballotbox ballotbox-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ballotbox-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ballotbox transaction") + "\n" +
                               "  ballotbox-tx [options] -create [commands]   " + _("Create hex-encoded ballotbox transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ballotbox transaction
