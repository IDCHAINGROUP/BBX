...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1642543210, 462487, "A drone attack in Abu Dhabi could mark a dangerous turning point for the Middle East");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256("0000080ed727f5967a615aca6fe5e45e4823c413d05bd4f54a98c1ab2a784973"));
        assert(genesis.hashMerkleRoot == uint256("058cef0ec76391137c9fd57854974bac751c869630a6394b78676f38d6334d2a"));
 
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // ballotbox starting difficulty is 1 / 2^12
        ...
        consensus.devAddress = "BDEWySVQ6uywWY7ja4ApRtpNTdCpK2rVmy";
				
        // spork key
        consensus.strSporkPubKey = "04989c143c6033d16897bc302b65898765d942c7f17790ab9cfb369f18bb30f0fdde958811beda1af94914095d536ae8290e887bd9d801cdd3506d0dae1ea04da2";
        ...
        vSeeds.push_back(CDNSSeedData("108.61.23.94", "108.61.23.94"));
        vSeeds.push_back(CDNSSeedData("149.28.235.51", "149.28.235.51"));
        vSeeds.push_back(CDNSSeedData("207.246.82.120", "207.246.82.120"));
        vSeeds.push_back(CDNSSeedData("207.148.17.239", "207.148.17.239"));

        // Note that of those with the service bits flag, most only support a subset of possible options

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 25);  // BBX addresses start with 'B'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 10);  // BBX script addresses start with '5'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 75); // BBX private keys start with 'X'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 212);
        // BBX BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // BBX BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
...
*/
	...
	//assert(consensus.hashGenesisBlock == uint256S("0x001"));
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 14;   // ballotbox starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        consensus.nBudgetCycleBlocks = 43200;       // approx. 1 every 30 days
        consensus.nBudgetFeeConfirmations = 6;      // Number of confirmations for the finalization fee
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 75); // BBX addresses start with 'X'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 4); // BBX script addresses start with '3'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 80); // BBX private keys start with 'Z'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 212);
        // BBX BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
	base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
	// BBX BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
