...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ballotboxGUI* window = static_cast<ballotboxGUI*>(parentWidget());
...
{
    ballotboxGUI* gui = static_cast<ballotboxGUI*>(parentWidget());
...
{
    hide();
    static_cast<ballotboxGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Ballotbox Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BBXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
