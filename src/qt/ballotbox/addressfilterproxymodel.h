...
#ifndef ballotbox_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define ballotbox_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //ballotbox_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
