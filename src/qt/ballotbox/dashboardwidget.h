...
#include "qt/ballotbox/txviewholder.h"
...
#include "config/ballotbox-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(ballotboxGUI* _window);
    ~DashboardWidget();
