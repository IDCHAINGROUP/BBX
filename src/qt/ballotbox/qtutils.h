...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ballotboxGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ballotboxGUI* gui, double posX = 3);
