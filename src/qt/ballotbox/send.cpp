...
#include "qt/ballotbox/forms/ui_send.h"
#include "qt/ballotbox/addnewcontactdialog.h"
#include "qt/ballotbox/qtutils.h"
#include "qt/ballotbox/sendchangeaddressdialog.h"
#include "qt/ballotbox/optionbutton.h"
#include "qt/ballotbox/sendconfirmdialog.h"
#include "qt/ballotbox/myaddressrow.h"
#include "qt/ballotbox/guitransactionsutils.h"
...
SendWidget::SendWidget(ballotboxGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-ballotbox");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination ballotboxAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(ballotboxAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(ballotboxAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
