...
#include "qt/ballotbox/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ballotboxGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ballotboxGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
