...
#include "qt/ballotbox/settings/settingsbackupwallet.h"
#include "qt/ballotbox/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/ballotbox/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(ballotboxGUI* _window, QWidget *parent) :
