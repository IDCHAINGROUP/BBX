...
#include "qt/ballotbox/settings/settingsbittoolwidget.h"
#include "qt/ballotbox/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(ballotboxGUI* _window, QWidget *parent) :
