...
#include "qt/ballotbox/settings/settingsconsolewidget.h"
#include "qt/ballotbox/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ballotbox/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ballotboxGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Ballotbox Coin RPC console.") + "<br>" +
