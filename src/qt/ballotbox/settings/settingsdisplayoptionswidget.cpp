...
#include "qt/ballotbox/settings/settingsdisplayoptionswidget.h"
#include "qt/ballotbox/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(ballotboxGUI* _window, QWidget *parent) :
