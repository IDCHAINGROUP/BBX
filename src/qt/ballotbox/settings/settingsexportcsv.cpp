...
#include "qt/ballotbox/settings/settingsexportcsv.h"
#include "qt/ballotbox/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(ballotboxGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("ballotbox_tx_csv_export(*.csv)") : tr("ballotbox_addresses_csv_export(*.csv)"),
                                        nullptr);
