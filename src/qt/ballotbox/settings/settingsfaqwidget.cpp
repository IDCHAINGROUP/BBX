...
#include "qt/ballotbox/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ballotbox/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(ballotboxGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBBX,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBBX,
    ...
    connect(ui->pushButton_UnspendableBBX, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBBX);});
    ...
    if (parent)
        connect(parent, &ballotboxGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
