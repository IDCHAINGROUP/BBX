...
#include "qt/ballotbox/settings/settingsmultisendwidget.h"
#include "qt/ballotbox/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/ballotbox/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other Ballotbox Coin addresses after it matures."));
