...
#include "qt/ballotbox/settings/settingsnetworkwidget.h"
#include "qt/ballotbox/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ballotbox/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ballotboxGUI* _window, QWidget *parent) :
