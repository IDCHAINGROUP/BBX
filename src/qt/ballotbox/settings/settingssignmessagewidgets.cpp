...
#include "qt/ballotbox/settings/settingssignmessagewidgets.h"
#include "qt/ballotbox/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(ballotboxGUI* _window, QWidget *parent) :
