...
#include "qt/ballotbox/settings/settingswalletrepairwidget.h"
#include "qt/ballotbox/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ballotbox/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ballotboxGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ballotboxGUI::handleRestart()
