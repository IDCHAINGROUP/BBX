...
#include "qt/ballotbox/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(ballotboxGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &ballotboxGUI::openFAQ);
