...
#include "qt/ballotbox/topbar.h"
#include "qt/ballotbox/forms/ui_topbar.h"
#include "qt/ballotbox/lockunlock.h"
#include "qt/ballotbox/qtutils.h"
#include "qt/ballotbox/receivedialog.h"
#include "qt/ballotbox/loadingdialog.h"
...
TopBar::TopBar(ballotboxGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBBX}, "amount-small-topbar");
    setCssProperty({ui->labelAmountBBX}, "amount-topbar");
    setCssProperty({ui->labelPendingBBX, ui->labelImmatureBBX}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("ballotbox")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // BBX Total
    QString totalBBX = GUIUtil::formatBalance(balance, nDisplayUnit);

    // BBX
    // Top
    ui->labelAmountTopBBX->setText(totalBBX);
    // Expanded
    ui->labelAmountBBX->setText(totalBBX);
    ui->labelPendingBBX->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureBBX->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
