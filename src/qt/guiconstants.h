...
/* ballotbox GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ballotbox Coin"
#define QAPP_ORG_DOMAIN "ballotbox.dev"
#define QAPP_APP_NAME_DEFAULT "Ballotbox Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Ballotbox Coin-Qt-testnet"
