...
/** Utility functions used by the ballotbox Qt UI.
 */
namespace GUIUtil
{
...
// Render ballotbox addresses in monospace font
...
// Parse "ballotbox:" URI into recipient object, return true on successful parsing
