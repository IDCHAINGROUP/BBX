...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Ballotbox Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Ballotbox Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ballotbox features */
        {"ballotbox", "listmasternodes", &listmasternodes, true, true, false},
        {"ballotbox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ballotbox", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ballotbox", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ballotbox", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ballotbox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ballotbox", "masternodedebug", &masternodedebug, true, true, false},
        {"ballotbox", "startmasternode", &startmasternode, true, true, false},
        {"ballotbox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ballotbox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ballotbox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ballotbox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ballotbox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ballotbox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ballotbox", "preparebudget", &preparebudget, true, true, false},
        {"ballotbox", "submitbudget", &submitbudget, true, true, false},
        {"ballotbox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ballotbox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ballotbox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ballotbox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ballotbox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ballotbox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ballotbox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ballotbox", "checkbudgets", &checkbudgets, true, true, false},
        {"ballotbox", "mnsync", &mnsync, true, true, false},
        {"ballotbox", "spork", &spork, true, true, false},
...
{
    return "> ballotbox-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1751/\n";
}
